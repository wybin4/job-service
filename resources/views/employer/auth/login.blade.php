...
<x-employer-guest-layout>
    <x-auth-card>
        ...
        <h2 class="header-text text-center">Войти как работодатель</h2>
        ...
        <form method="POST" action="{{ route('employer.login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('employer.password.request') }}">
                    {{ __('Забыли пароль?') }}
                </a>
                @endif
