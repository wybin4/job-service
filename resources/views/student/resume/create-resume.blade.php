				...
				<div id="resume-card">
					...
					<div id="work-exp-div" class="card-div">
						...
						<div id="area-add-work-exp" style="display:none">
							...
							<div style="margin-top:20px">
								<x-label>Начало<span style="padding-left:220px">Окончание</span></x-label>
								<select id="add-normal-select-4" class="single-selector" placeholder-text="Месяц">
								...
								<select id="add-normal-select-5" class="single-selector" placeholder-text="Год">
								</select>
								<select id="add-normal-select-6" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="add-normal-select-7" class="single-selector" placeholder-text="Год">
								</select>
							</div>
							<div style="margin-top:20px">
						...
						<div id="area-edit-work-exp" style="display:none">
							...
							<div style="margin-top:20px">
								<x-label>Начало<span style="padding-left:220px">Окончание</span></x-label>
								<select id="edit-normal-select-4" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="edit-normal-select-5" class="single-selector" placeholder-text="Год">
								</select>
								<select id="edit-normal-select-6" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="edit-normal-select-7" class="single-selector" placeholder-text="Год">
								</select>
							</div>
							<div style="margin-top:20px">
								<x-label :value="__('Подробности')" />
					...
					<div id="edu-div" class="card-div">
						...
						<div id="area-add-edu" style="display:none">
							...
							<div style="margin-top:20px">
								<x-label>Начало<span style="padding-left:220px">Окончание</span></x-label>
								<select id="add-normal-select-8" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="add-normal-select-9" class="single-selector" placeholder-text="Год">
								</select>
								<select id="add-normal-select-10" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="add-normal-select-11" class="single-selector" placeholder-text="Год">
								</select>
							</div>
							<div style="margin-top:20px">
								<x-label :value="__('Подробности')" />
						...
						<div id="area-edit-edu" style="display:none">
							...
							<div style="margin-top:20px">
								<x-label>Начало<span style="padding-left:220px">Окончание</span></x-label>
								<select id="edit-normal-select-8" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="edit-normal-select-9" class="single-selector" placeholder-text="Год">
								</select>
								<select id="edit-normal-select-10" class="single-selector" placeholder-text="Месяц">
									<option value="00">Месяц</option>
									<option value="01">Январь</option>
									<option value="02">Февраль</option>
									<option value="03">Март</option>
								...
								<select id="edit-normal-select-11" class="single-selector" placeholder-text="Год">
								</select>
							</div>
							<div style="margin-top:20px">
								<x-label :value="__('Подробности')" />
...
<script>
	function open_rate_area() {
		...
		if (hard_skills && $('#select-1').val() && $('#select-2').val() && $('#select-3').val()) {
			...
			$('#resume-card').hide();
			$('#rating-card').show();
			$('#rate-skills').css('background-color', 'rgba(165, 180, 252, 0.5');
	...
	$('#save-edu').click(function() {
		...
		if ($('#add_university_name').val() !== "" || $('#add_speciality_name').val() !== "") {
			...
			$('.edu-edit').on('click', function() {
				...
				$('#edit_edu_date_start').val(edu_date_start);
				$('#edit_edu_date_end').val(edu_date_end);
	...
	$('#add-resume').click(function() {
		$('#resume-card').show();
		$('#rating-card').hide();
		$('#add-resume').css('background-color', 'rgba(165, 180, 252, 0.5');
